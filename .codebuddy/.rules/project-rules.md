...
alwaysApply: true
enabled: true
updatedAt: 2026-01-08T10:26:16.676Z
provider: 
detailLevel: full
---

# Architect Rule Set
> Generated by Architect Rule Loader V7 (Remote)
> Generated at: 2026-01-08T10:26:16.676Z
...
<!-- Source: layer3_action/refactoring.md -->
...
<!-- Source: layer3_action/debugging.md -->
...
保持**假设-验证**的科学思维：先提出假设，再用��志/断点验证。
...
<!-- Source: layer3_action/testing.md -->
...
<!-- Source: layer3_action/self-verification.md -->
...
**检测方��**：查看目标项目的 `package.json` 中的 `devDependencies` 和 `scripts`。
