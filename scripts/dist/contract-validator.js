...
exports.runContractValidation = runContractValidation;
...
function parseArgs(argv) {
    ...
    for (let i = 0; i < argv.length; i++) {
        ...
        else if (a === '--check-architecture-constraints')
            parsed.checkArchitectureConstraints = true;
        else if (a === '--json')
            parsed.json = true;
        else if (a === '--quiet')
            parsed.quiet = true;
...
function validateArchitectureConstraintsForAgentCall(requestId, promptFile, resultFile, promptHeader) {
    ...
    if (isNonEmptyString(promptHeader.promptPath) && toPosixRelative(promptHeader.promptPath) !== expectedPromptPath) {
        issues.push({
            level: 'warning',
            file: (_a = promptFile !== null && promptFile !== void 0 ? promptFile : resultFile) !== null && _a !== void 0 ? _a : requestId,
    ...
    if (isNonEmptyString(promptHeader.resultPath) && toPosixRelative(promptHeader.resultPath) !== expectedResultPath) {
        issues.push({
            level: 'warning',
            file: (_b = promptFile !== null && promptFile !== void 0 ? promptFile : resultFile) !== null && _b !== void 0 ? _b : requestId,
    ...
    if (promptRelative && promptRelative !== expectedPromptPath) {
        issues.push({
            level: 'warning',
            file: promptFile !== null && promptFile !== void 0 ? promptFile : requestId,
    ...
    if (resultRelative && resultRelative !== expectedResultPath) {
        issues.push({
            level: 'warning',
            file: resultFile !== null && resultFile !== void 0 ? resultFile : requestId,
...
function runContractValidation(argv, cwd = process.cwd()) {
    ...
    try {
        ...
        for (const it of agentCallItems) {
            ...
            if (args.checkArchitectureConstraints) {
                issues.push(...validateArchitectureConstraintsForAgentCall(it.requestId, it.promptFile, it.resultFile, promptHeader && promptHeader.ok ? promptHeader.header : null));
            }
        }
