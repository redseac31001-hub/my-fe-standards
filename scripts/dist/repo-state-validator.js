...
exports.looksLikeRepositoryFactRoot = looksLikeRepositoryFactRoot;
exports.validateRepoStateRoot = validateRepoStateRoot;
exports.finalizeRepoStateValidation = finalizeRepoStateValidation;
...
function extractLatestDateFromText(text) {
    ...
    if (matches.length === 0)
        return null;
    return (_a = matches.sort().at(-1)) !== null && _a !== void 0 ? _a : null;
}
...
function main() {
    ...
    if (json) {
        ...
        console.log(`[repo-state-validator] checked files: ${payload.checkedFileCount}, checks: ${payload.checkedRuleCount}, errors: ${payload.errorCount}, warnings: ${payload.warningCount}`);
