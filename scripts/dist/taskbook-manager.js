...
const IN_PROCESS_LOCK_DEPTHS = new Map();
...
class TaskBookManager {
    constructor(projectRoot = process.cwd(), options = {}) {
        ...
        this.lockTimeoutMs = (_a = options.lockTimeoutMs) !== null && _a !== void 0 ? _a : LOCK_TIMEOUT_MS;
        this.lockRetryMs = (_b = options.lockRetryMs) !== null && _b !== void 0 ? _b : LOCK_RETRY_MS;
    }
    getProjectRoot() {
        return this.baseDir;
    }
    ...
    cleanupLockFile(lockPath) {
        for (let attempt = 0; attempt < TASKBOOK_FILE_DELETE_MAX_RETRIES; attempt++) {
            try {
                ...
                if (TASKBOOK_FILE_DELETE_RETRY_CODES.has((err === null || err === void 0 ? void 0 : err.code) || '') && attempt < TASKBOOK_FILE_DELETE_MAX_RETRIES - 1) {
                    try {
                        ...
                        const rmErr = rmError;
                        if ((rmErr === null || rmErr === void 0 ? void 0 : rmErr.code) === 'ENOENT') {
                            return;
                        }
                    }
    ...
    getInProcessLockDepth(taskBookId) {
        var _a;
        return (_a = IN_PROCESS_LOCK_DEPTHS.get(taskBookId)) !== null && _a !== void 0 ? _a : 0;
    }
    ...
    withTaskBookLock(taskBookId, fn, opts) {
        ...
        const timeoutMs = (_a = opts === null || opts === void 0 ? void 0 : opts.timeoutMs) !== null && _a !== void 0 ? _a : this.lockTimeoutMs;
        while (true) {
            try {
    ...
    load(id) {
        ...
        return activeTaskBook !== null && activeTaskBook !== void 0 ? activeTaskBook : historyTaskBook;
    }
    /**
     * 列出所有活跃的 TaskBook
     */
    listActive() {
        ...
        for (const fileName of files) {
            ...
            if (!activeTaskBook)
                continue;
            if (isTerminalTaskBookStatus(activeTaskBook.status))
                continue;
...
function loadPlannerAgentDefinition(projectRoot) {
    const candidates = (0, install_roots_1.listAgentDefinitionCandidatePaths)(projectRoot, 'planner');
    ...
    try {
        switch (parsed.command) {
            ...
            case 'plan': {
                ...
                if (!agentDef) {
                    const candidates = (0, install_roots_1.listAgentDefinitionCandidatePaths)(process.cwd(), 'planner')
...
if ((0, cli_entry_1.isDirectCliEntry)('taskbook-manager.js')) {
    main();
}
